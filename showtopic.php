...
$display_block .= " <a href='addtopic.php'>
 <button type= 'button' value= 'back'>ADD TOPIC</button></a>";
$display_block .= " <a href='topiclist.php'>
 <button type= 'button' value= 'back'>SHOW TOPIC LIST</button></a>";
?>
<!DOCTYPE html>
<html>
